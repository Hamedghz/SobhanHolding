...
Auth::requireLogin(); $pageTitle='داشبورد';
...
<div class="card"><h2>دسترسی سریع</h2><div class="actions"><a class="btn" href="/admin/survey-results.php">نتایج ارزیابی</a><a class="btn" href="/admin/files.php">فایل‌های من</a><?php if(Auth::isAdmin()): ?><a class="btn" href="/admin/users.php">مدیریت کاربران</a><a class="btn" href="/admin/carousel.php">مدیریت اسلایدر</a><?php endif; ?></div></div>
