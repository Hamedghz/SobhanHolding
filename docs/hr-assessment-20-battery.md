...
- Seedهای قبلی در همه حالت‌ها آرشیو و غیرفعال می‌شوند؛ حتی در دیتابیس بدون پاسخ یا نتیجه نیز رکورد تاریخی حذف نمی‌شود.
...
در صفحه مدیریت سؤال، مدیر دیگر JSON گزینه‌ها را ویرایش نمی‌کند. گزینه‌های پاسخ انتخابی به‌صورت «مقدار|عنوان» در خطوط جدا ثبت می‌شوند و طیف‌های ۱ تا ۵، ۱ تا ۷ و بله/خیر به‌صورت خودکار به ساختار داخلی امن تبدیل می‌شوند.
