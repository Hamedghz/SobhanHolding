...
if($mainDashboard-notmatch'personal-planner-widget.php' -or $employeeDashboard-notmatch'personal-planner-widget.php'){throw 'Planner widget is missing from a personal dashboard.'}
